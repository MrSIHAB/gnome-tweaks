...
LIGHT_IMAGE="IceCubeLight.png"
DARK_IMAGE="IceCubeDark.jpg"
XML_FILE="IceCube.xml"
...
if [[ "$1" == "-r" || "$1" == "--remove" ]]; then
    ...
    echo "IceCube wallpaper removed successfully."
    exit 0
fi
...
echo "IceCube wallpaper installed successfully."
